...
import {mnemonicToMiniSecret} from '../../mnemonic/index';
import {sr25519PairFromSeed} from '../index';
...
describe('sr25519PairFromSeed', (): void => {
  ...
  const RESULT = {
    ...
    secretKey: new Uint8Array([
      240, 16, 102, 96, 195, 221, 162, 63, 22, 218, 169, 172, 91, 129, 27, 150, 48, 119, 245, 188,
      10, 248, 159, 133, 128, 79, 13, 232, 228, 36, 240, 80, 249, 141, 102, 243, 148, 66, 80, 111,
      249, 71, 253, 145, 31, 24, 199, 167, 165, 218, 99, 154, 99, 232, 211, 180, 226, 51, 247, 65,
      67, 217, 81, 193,
    ]),
  };
  ...
  it('generates a valid publicKey/secretKey pair (u8a)', (): void => {
    expect(sr25519PairFromSeed(TEST)).toEqual(RESULT);
  });
