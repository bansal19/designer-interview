...
import {sr25519Agreement, sr25519PairFromSeed} from './index';
...
describe('agreement', (): void => {
  ...
  it('matches a known agreement (both ways)', (): void => {
    ...
    expect(u8aToHex(sr25519Agreement(pairA.secretKey, pairB.publicKey))).toEqual(TEST);
    expect(u8aToHex(sr25519Agreement(pairB.secretKey, pairA.publicKey))).toEqual(TEST);
  });
});
