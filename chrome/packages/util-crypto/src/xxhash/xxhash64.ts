...
// Adapted from https://github.com/pierrec/js-xxhash/blob/0504e76f3d31a21ae8528a7f590c7289c9e431d2/lib/xxhash64
//
...
export function xxhash64(input: Uint8Array, initSeed: bigint | number): Uint8Array {
  ...
  let h64 =
    ...
    (BigInt(input.length) +
      (input.length >= 32
        ? ((((((((rotl(v1, _1n) + rotl(v2, _7n) + rotl(v3, _12n) + rotl(v4, _18n)) ^
  ...
  while (p <= u8asize - 8) {
    h64 =
      U64 & (P64_4 + P64_1 * rotl(h64 ^ (P64_1 * rotl(P64_2 * fromU8a(u8a, p, 4), _31n)), _27n));
    p += 8;
  }
