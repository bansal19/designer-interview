...
describe('xxhashAsU8a', (): void => {
  ...
  for (const onlyJs of [false, true]) {
    describe(`onlyJs=${(onlyJs && 'true') || 'false'}`, (): void => {
      it('returns a 64-bit value by default', (): void => {
        expect(xxhashAsU8a('abc', undefined, onlyJs)).toEqual(hexToU8a('0x990977adf52cbc44'));
      });

      it('returns a 128-bit value (as specified', (): void => {
        expect(xxhashAsU8a('abc', 128, onlyJs)).toEqual(
          hexToU8a('0x990977adf52cbc440889329981caa9be'),
        );
      });

      it('returns a 256-bit value (as specified)', (): void => {
        expect(xxhashAsU8a('abc', 256, onlyJs)).toEqual(
  ...
  perfWasm('xxhashAsU8a', 8000, (input, onlyJs) => xxhashAsU8a(input, 128, onlyJs));
});
