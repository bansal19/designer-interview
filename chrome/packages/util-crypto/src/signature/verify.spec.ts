...
import {decodeAddress} from '../address/index';
...
describe('signatureVerify', (): void => {
  ...
  describe('verifyDetect', (): void => {
    ...
    it('allows various inputs', (): void => {
      expect(
        signatureVerify(stringToU8a(MESSAGE), hexToU8a(SIG_ED), decodeAddress(ADDR_ED)),
      ).toEqual({
        crypto: 'ed25519',
        isValid: true,
        isWrapped: false,
    ...
    it('fails on an invalid signature', (): void => {
      expect(signatureVerify(MESSAGE, MUL_SR, ADDR_ED)).toEqual({
        ...
        publicKey: new Uint8Array([
          61, 12, 55, 211, 0, 211, 97, 199, 4, 37, 17, 213, 81, 175, 166, 23, 251, 199, 144, 210,
          19, 83, 186, 1, 196, 231, 14, 156, 171, 46, 141, 146,
        ]),
      });
    });
  });
