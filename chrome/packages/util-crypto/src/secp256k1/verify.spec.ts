...
import {secp256k1PairFromSeed, secp256k1Verify} from './index';
    ...
    describe(`onlyJs=${(onlyJs && 'true') || 'false'}`, (): void => {
      ...
      for (const isPublic of [false, true]) {
        describe(`validation against known, isPublic=${(isPublic && 'true') || 'false'}`, (): void => {
          const pair = secp256k1PairFromSeed(
            hexToU8a('0x4380de832af797688026ce24f85204d508243f201650c1a134929e5458b7fbae'),
          );
          const msg = hexToU8a(
            '0xa30b64ce1eedf409c8afb801d72c05234e64849ea538c15dd3c8cf4ffcf166c9',
          );
          const addr = isPublic ? pair.publicKey : hasher('blake2', pair.publicKey, onlyJs);
