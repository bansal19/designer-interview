...
import {secp256k1PairFromSeed, secp256k1Sign} from './index';
...
describe('sign', (): void => {
  ...
  for (const onlyJs of [false, true]) {
    describe(`onlyJs=${(onlyJs && 'true') || 'false'}`, (): void => {
      it('generates a known signature', (): void => {
        expect(secp256k1Sign(msg, pair, undefined, onlyJs)).toEqual(
          hexToU8a(
  ...
  perfWasm('secp256k1Sign', 1000, (_, onlyJs) => secp256k1Sign(msg, pair, undefined, onlyJs));
});
