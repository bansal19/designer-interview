...
// Adapted from https://github.com/dchest/tweetnacl-js/blob/6a9594a35a27f9c723c5f1c107e376d1c65c23b3/test/04-secretbox.quick
// Adapted from https://github.com/dchest/tweetnacl-js/blob/6a9594a35a27f9c723c5f1c107e376d1c65c23b3/test/04-secretbox
//
// Changes made:
...
import {base64Decode} from '../base64/index';
import {naclSecretbox, naclSecretboxOpen} from './tweetnacl';
import {TEST_DATA} from './tweetnacl-secretbox-data.spec';

describe('tweetnacl/secretbox', (): void => {
  describe('tweetnacl/test/04-secretbox.quick', (): void => {
  ...
  describe('tweetnacl/test/04-secretbox', (): void => {
